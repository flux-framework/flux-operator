...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FluxEtcHosts) DeepCopyInto(out *FluxEtcHosts) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FluxEtcHosts.
func (in *FluxEtcHosts) DeepCopy() *FluxEtcHosts {
	if in == nil {
		return nil
	}
	out := new(FluxEtcHosts)
	in.DeepCopyInto(out)
	return out
}
