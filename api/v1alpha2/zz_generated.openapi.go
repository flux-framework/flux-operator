...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/flux-framework/flux-operator/api/v1alpha2.BurstedCluster":       schema_flux_framework_flux_operator_api_v1alpha2_BurstedCluster(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.Bursting":             schema_flux_framework_flux_operator_api_v1alpha2_Bursting(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.Commands":             schema_flux_framework_flux_operator_api_v1alpha2_Commands(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.ContainerResources":   schema_flux_framework_flux_operator_api_v1alpha2_ContainerResources(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.ContainerVolume":      schema_flux_framework_flux_operator_api_v1alpha2_ContainerVolume(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.FluxBroker":           schema_flux_framework_flux_operator_api_v1alpha2_FluxBroker(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.FluxContainer":        schema_flux_framework_flux_operator_api_v1alpha2_FluxContainer(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.FluxScheduler":        schema_flux_framework_flux_operator_api_v1alpha2_FluxScheduler(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.FluxSpec":             schema_flux_framework_flux_operator_api_v1alpha2_FluxSpec(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.LifeCycle":            schema_flux_framework_flux_operator_api_v1alpha2_LifeCycle(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.LoggingSpec":          schema_flux_framework_flux_operator_api_v1alpha2_LoggingSpec(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.MiniCluster":          schema_flux_framework_flux_operator_api_v1alpha2_MiniCluster(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterArchive":   schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterArchive(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterContainer": schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterContainer(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterList":      schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterList(ref),
		"github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterSpec":      schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterSpec(ref),
...
func schema_flux_framework_flux_operator_api_v1alpha2_BurstedCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_flux_framework_flux_operator_api_v1alpha2_Bursting(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"leadBroker": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.FluxBroker"),
						},
					},
					"hostlist": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.BurstedCluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.BurstedCluster", "github.com/flux-framework/flux-operator/api/v1alpha2.FluxBroker"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_Commands(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_ContainerResources(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_flux_framework_flux_operator_api_v1alpha2_ContainerVolume(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_FluxBroker(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_flux_framework_flux_operator_api_v1alpha2_FluxContainer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"resources": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.ContainerResources"),
						},
					},
					"imagePullSecret": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.ContainerResources"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_FluxScheduler(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_flux_framework_flux_operator_api_v1alpha2_FluxSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"container": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.FluxContainer"),
						},
					},
					"arch": {
						SchemaProps: spec.SchemaProps{
					...
					"scheduler": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.FluxScheduler"),
						},
					},
					"mungeSecret": {
						SchemaProps: spec.SchemaProps{
					...
					"bursting": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.Bursting"),
						},
					},
					"brokerConfig": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.Bursting", "github.com/flux-framework/flux-operator/api/v1alpha2.FluxContainer", "github.com/flux-framework/flux-operator/api/v1alpha2.FluxScheduler"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_LifeCycle(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_LoggingSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_MiniCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterSpec", "github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterArchive(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterContainer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.Secret"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.ContainerVolume"),
									},
								},
							},
						},
					...
					"lifeCycle": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.LifeCycle"),
						},
					},
					"resources": {
						SchemaProps: spec.SchemaProps{
					...
					"commands": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.Commands"),
						},
					},
					"securityContext": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.SecurityContext"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.Commands", "github.com/flux-framework/flux-operator/api/v1alpha2.ContainerResources", "github.com/flux-framework/flux-operator/api/v1alpha2.ContainerVolume", "github.com/flux-framework/flux-operator/api/v1alpha2.LifeCycle", "github.com/flux-framework/flux-operator/api/v1alpha2.Secret", "github.com/flux-framework/flux-operator/api/v1alpha2.SecurityContext"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.MiniCluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.MiniCluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterContainer"),
									},
								},
							},
						},
					...
					"network": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.Network"),
						},
					},
					"jobLabels": {
						SchemaProps: spec.SchemaProps{
					...
					"flux": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.FluxSpec"),
						},
					},
					"logging": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.LoggingSpec"),
						},
					},
					"archive": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterArchive"),
						},
					},
					...
					"pod": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/flux-framework/flux-operator/api/v1alpha2.PodSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.FluxSpec", "github.com/flux-framework/flux-operator/api/v1alpha2.LoggingSpec", "github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterArchive", "github.com/flux-framework/flux-operator/api/v1alpha2.MiniClusterContainer", "github.com/flux-framework/flux-operator/api/v1alpha2.Network", "github.com/flux-framework/flux-operator/api/v1alpha2.PodSpec"},
	}
}

func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterUser(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_Network(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_flux_framework_flux_operator_api_v1alpha2_Secret(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_flux_framework_flux_operator_api_v1alpha2_SecurityContext(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
