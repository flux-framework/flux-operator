...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/flux-framework/flux-operator/api/v1alpha2.Toleration":           schema_flux_framework_flux_operator_api_v1alpha2_Toleration(ref),
	}
}
...
func schema_flux_framework_flux_operator_api_v1alpha2_MiniClusterContainer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.Commands", "github.com/flux-framework/flux-operator/api/v1alpha2.ContainerVolume", "github.com/flux-framework/flux-operator/api/v1alpha2.LifeCycle", "github.com/flux-framework/flux-operator/api/v1alpha2.Secret", "k8s.io/api/core/v1.ResourceRequirements", "k8s.io/api/core/v1.SecurityContext"},
	}
}
...
func schema_flux_framework_flux_operator_api_v1alpha2_PodSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nodeAffinity": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeAffinity is for a list of values assoicated with a label",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"tolerations": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/flux-framework/flux-operator/api/v1alpha2.Toleration"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/flux-framework/flux-operator/api/v1alpha2.Toleration", "k8s.io/api/core/v1.PodSecurityContext", "k8s.io/apimachinery/pkg/api/resource.Quantity"},
	}
}
...
func schema_flux_framework_flux_operator_api_v1alpha2_Toleration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
