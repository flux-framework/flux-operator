...
class ApiV1alpha1MiniClusterList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([ApiV1alpha1MiniCluster],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """ApiV1alpha1MiniClusterList - a model defined in OpenAPI

        Args:
            items ([ApiV1alpha1MiniCluster]):
