...
class PodSpec(BaseModel):
    ...
    host_ipc: Optional[StrictBool] = Field(default=None, description="Security", alias="hostIPC")
    ...
    __properties: ClassVar[List[str]] = ["annotations", "automountServiceAccountToken", "hostIPC", "hostNetwork", "labels", "nodeSelector", "resources", "restartPolicy", "runtimeClassName", "schedulerName", "serviceAccountName"]
